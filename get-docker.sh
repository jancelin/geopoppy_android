...
do_install() {
	...
	STATIC_RELEASE_URL="https://download.docker.com/linux/static/stable/aarch64/docker-19.03.2.tgz"
	STATIC_RELEASE_ROOTLESS_URL="https://download.docker.com/linux/static/stable/aarch64/docker-rootless-extras-19.03.2.tgz"
